...
def get_id_city_highprice(city):  # функция получения айди введенного города
    """
...
def get_hotels_highprice(id_city, num_hotels, check_in,
    ...
    data_hotel = reversed(converted_data['data']['body']['searchResults'][
                              'results'])  # полученные данные списка переворачиваем используя команду reversed, список нужно перевернуть т.к нужно вывести отели по цене от меньшего к большему
